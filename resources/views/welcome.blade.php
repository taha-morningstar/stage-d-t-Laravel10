	          ...
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <h1 class="mb-4 mt-3">WE ARE <span>VAERDIA SOLUTIONS</span></h1>
			            <h2 class="mb-4">NEW TECH</h2>
			            <p><a  href="{{ route('admin.login') }}" class="btn btn-primary py-3 px-4">LOG IN</a> <a href="{{ route('register') }}" class="btn btn-white btn-outline-white py-3 px-4">REGISTER</a></p>
	      ...
	      <div class="slider-item">
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third js-fullheight order-md-last img" style="background-image:url(images/about.jpg);">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
			            <h1 class="mb-4 mt-3"> We are <span>Full stack Team</span> based in Tunisia</h1>
			            <p><a  href="{{ route('admin.login') }}" class="btn btn-primary py-3 px-4">LOG IN</a> <a href="{{ route('register') }}" class="btn btn-white btn-outline-white py-3 px-4">REGISTER</a></p>
		            </div>
		          </div>
	        	</div>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/project-3.jpg);">
	    				</div>
    				</div>
    			</div>
