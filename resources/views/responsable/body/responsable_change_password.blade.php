        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                                  ...
                                  <h6 class="card-title"> Responsable Change Password </h6>

                                  <form method="POST" action="{{route('responsable.update.password')}}" class="forms-sample" enctype="multipart/form-data">
                                    @csrf
